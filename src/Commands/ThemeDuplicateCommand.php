...
class ThemeDuplicateCommand extends Command
{
     ...
     * @return \Fcl\Theme\Commands\ThemeDuplicateCommand
     */
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, 'Name of the theme to duplicate.'],
            ['new-name', InputArgument::REQUIRED, 'Name of the new theme.'],
        ];
    }
